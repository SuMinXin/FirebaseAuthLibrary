    ...
    public class FirebaseAuthProvider : IDisposable, IFirebaseAuthProvider
    {
        ...
        public async Task<User> GetUserAsync(string firebaseToken)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new vFirebaseAuthException(GoogleDeleteUserUrl, content, responseData, ex, errorReason);
            }
        }
        ...
        public async Task<FirebaseAuthLink> SignInAnonymouslyAsync()
        {
            ...
            return await this.ExecuteWithPostContentAsync(GoogleSignUpUrl, content, true).ConfigureAwait(false);
        }
        ...
        public async Task SendPasswordResetEmailAsync(string email)
        {
            ...
            {
                AuthErrorReason errorReason = GetFailureReason(responseData);
                throw new vFirebaseAuthException(GoogleGetConfirmationCodeUrl, content, responseData, ex, errorReason);
            }
        }
        ...
        public async Task<ProviderQueryResult> GetLinkedAccountsAsync(string email)
        {
            ...
            {
                throw new vFirebaseAuthException(GoogleCreateAuthUrl, content, responseData, ex);
            }
        }
        ...
        public async Task<FirebaseAuthLink> RefreshAuthAsync(FirebaseAuth auth)
        {
            ...
            {
                throw new vFirebaseAuthException(GoogleRefreshAuth, content, responseData, ex);
            }
        }
        ...
        private async Task<FirebaseAuthLink> ExecuteWithPostContentAsync(string googleUrl, string postContent, bool isSignInAnonymouslyAsync = false)
        {
            string responseData = "N/A";
            ...
            {
                AuthErrorReason errorReason = GetFailureReason(responseData);
                throw new vFirebaseAuthException(googleUrl, postContent, responseData, ex, errorReason);
            }
        }
