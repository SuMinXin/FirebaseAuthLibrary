namespace Firebase.Auth
{
    ...
    public class vFirebaseAuthException : Exception
    {
        public vFirebaseAuthException(string requestUrl, string requestData, string responseData, Exception innerException, AuthErrorReason reason = AuthErrorReason.Undefined) 
